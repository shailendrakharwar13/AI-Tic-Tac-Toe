...
A tic-tac-toe AI program that will never never able to loses. This program uses the minimax algorithm with alpha-beta pruning to reduce the search space.
